...
class DigitalInstrumentWidget(QGraphicsView):
  ...
  def initInsturment(self):
    ...
    self.noteDict = {
      Qt.Key_W: DiscreteNotes.C0,
      Qt.Key_Y: DiscreteNotes.D0,
      Qt.Key_R: DiscreteNotes.E0,
      Qt.Key_I: DiscreteNotes.F0,
      Qt.Key_F: DiscreteNotes.G0,
      Qt.Key_G: DiscreteNotes.A0,
      Qt.Key_C: DiscreteNotes.B0,
      Qt.Key_U: DiscreteNotes.Cs0,
      Qt.Key_H: DiscreteNotes.Ds0,
      Qt.Key_D: DiscreteNotes.Fs0,
      ...
      Qt.Key_Up: DiscreteNotes.Gs1,
      Qt.Key_Semicolon: DiscreteNotes.As1,
    }
